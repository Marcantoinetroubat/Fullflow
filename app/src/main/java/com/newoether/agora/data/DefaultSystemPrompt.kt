...
object DefaultSystemPrompt {
    ...
    private fun systemItems(): List<PromptTemplateItem> = listOf(
        ...
        custom(
            ...
            Web search:
            Use web_search for current, time-sensitive, or uncertain facts. Use web_fetch when a search result needs source-level detail. Prefer primary or official sources for technical, legal, medical, financial, or high-impact claims. When web search is used, cite sources as inline markdown links on the exact source URL (e.g. [source title](https://example.com/article)) right after the claim they support, and distinguish sourced facts from inference.
