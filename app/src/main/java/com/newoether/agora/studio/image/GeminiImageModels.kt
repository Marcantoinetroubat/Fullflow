...
enum class StudioImageModel(
    ...
    NANO_BANANA_2(
        ...
        description = "gemini-3.1-flash-image · Qualité supérieure, résolutions 512px à 4K, création et retouche",
        isPrimary = true,
    ),
    NANO_BANANA(
    ...
    NANO_BANANA_PRO(
        ...
        description = "gemini-3-pro-image · Raisonnement visuel avancé et retouche de haute fidélité",
    ),
    IMAGEN_3(
        id = "imagen-3",
        displayName = "Imagen 3",
        description = "imagen-3 · Rendu photoréaliste Google",
    );
